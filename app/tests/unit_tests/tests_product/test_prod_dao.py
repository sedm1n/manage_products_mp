...
@pytest.mark.parametrize(
    ...
    [
        ("test_create_product1", "test_create_product1", 
         "test_create_product1_desc", 99, 10, 
         "image_url", 1, 1, 5.0, True, True),
    ],
)
async def test_create_product(
    name: str, slug: str, description: str, price: int, stock: int, image_url: str,
    supplier_id: int, category_id: int, rating:float,
    is_active: bool, expected_result: bool
):
...
@pytest.mark.parametrize(
    ...
    [
        ("test_create_product1","new_test_create_product1", "new_test_create_product1", 2, 199, 110,
          "new_image_url", 2, 4.1, True, True),
        ("product2","new_test_create_product2", "new_test_create_product1", 2, 199, 110,
          "new_image_url", 2, 4.1, True, False),
    ],
)
